...
class ExternalOverrideTextsService
{
    ...
    {
        $this->cacheKey = GameDataConfig::cacheKey('external_override_texts');
        $this->path = GameDataConfig::path('external_override_texts');
    }

    public function content(): string
    {
        return Cache::rememberForever($this->cacheKey, function () {
            return ExternalOverrideText::query()
                ->orderBy('key')
                ->get()
